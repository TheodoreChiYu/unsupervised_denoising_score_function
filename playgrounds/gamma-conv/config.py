...
config = dict(
    description="Denoising with score function for GammaConv noise model.",
    running_config=dict(
        model_type="GammaConv",
        max_train_step=3,
        max_train_time=1.,
        use_fp16_train=True,
