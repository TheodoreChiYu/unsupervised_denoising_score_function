...
config = dict(
    description="Denoising with score function for GaussianConv noise model.",
    running_config=dict(
        model_type="GaussianConv",
        max_train_step=3,
        max_train_time=1.,
        use_fp16_train=True,
