...
extra_sigma = 5.  # add another gaussian noise
image_size = 128

config = dict(
    description="Denoising with score function for RayleighConv noise model.",
    running_config=dict(
        model_type="RayleighConv",
        max_train_step=3,
        max_train_time=1.,
        use_fp16_train=True,
