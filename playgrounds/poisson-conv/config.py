...
config = dict(
    description="Denoising with score function for PoissonConv noise model.",
    running_config=dict(
        model_type="PoissonConv",
        max_train_step=3,
        max_train_time=1.,
        use_fp16_train=True,
