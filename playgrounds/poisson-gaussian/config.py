...
work_dir = os.path.join(FILE_ROOT, "playgrounds", "poisson-gaussian")
train_batch_size = 1
micro_batch_size = 1
...
config = dict(
    description="Denoising with score function for PoissonGaussian noise "
                "model.",
    running_config=dict(
        model_type="PoissonGaussian",
        max_train_step=3,
        max_train_time=1.,
        use_fp16_train=True,
