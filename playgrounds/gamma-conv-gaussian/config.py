...
work_dir = os.path.join(FILE_ROOT, "playgrounds", "gamma-conv-gaussian")
train_batch_size = 1
micro_batch_size = 1
num_workers = 0  # must be specified carefully!
world_size = 1  # if distributed computing is applied, set it correctly!
noise_model = "gamma-conv-gaussian"
alpha = (127.5 / 25) ** 2  # noise model parameter
...
config = dict(
    description="Denoising with score function for GammaConvGaussian noise "
                "model.",
    running_config=dict(
        model_type="GammaConvGaussian",
        max_train_step=3,
        max_train_time=1.,
        use_fp16_train=True,
